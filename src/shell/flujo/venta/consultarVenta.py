from src.infraestructura.services.venta_service import (
    ...
    obtener_venta_por_id_sin_detalles as obtener_venta_por_id_sin_detalles_service,
    obtener_venta_por_id_con_detalles as obtener_venta_por_id_con_detalles_service,
    obtener_detalle_venta_por_venta_id as obtener_detalle_venta_por_venta_id_service,
)
